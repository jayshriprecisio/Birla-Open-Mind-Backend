...
export const createController = async (req: NextRequest) => {
  try {
    ...
    const data = await createService({
      cheque_in_favour_of: v.cheque_in_favour_of,
      fees_type: v.fees_type,
      status: v.status,
    ...
    return NextResponse.json({
      success: true,
      data,
      message: 'Cheque in favour of master entry created successfully',
    });
  } catch (error: unknown) {
    return NextResponse.json(
      { success: false, message: formatApiError(error) },
...
export const updateController = async (req: NextRequest) => {
  try {
    ...
    return NextResponse.json({
      success: true,
      data,
      message: 'Cheque in favour of master entry updated successfully',
    });
  } catch (error: unknown) {
    return NextResponse.json(
      { success: false, message: formatApiError(error) },
...
export const deleteController = async (req: NextRequest) => {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Cheque in favour of master entry deleted successfully',
    });
  } catch (error: unknown) {
    return NextResponse.json(
      { success: false, message: formatApiError(error) },
