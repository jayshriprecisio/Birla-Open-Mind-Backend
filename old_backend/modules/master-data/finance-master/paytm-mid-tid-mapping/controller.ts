...
export const createController = async (req: NextRequest) => {
  try {
    ...
    return NextResponse.json({
      success: true,
      data,
      message: 'Paytm MID TID mapping created successfully',
    });
  } catch (error: unknown) {
    return NextResponse.json(
      { success: false, message: formatApiError(error) },
...
export const updateController = async (req: NextRequest) => {
  try {
    ...
    return NextResponse.json({
      success: true,
      data,
      message: 'Paytm MID TID mapping updated successfully',
    });
  } catch (error: unknown) {
    return NextResponse.json(
      { success: false, message: formatApiError(error) },
...
export const deleteController = async (req: NextRequest) => {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Paytm MID TID mapping deleted successfully',
    });
  } catch (error: unknown) {
    return NextResponse.json(
      { success: false, message: formatApiError(error) },
