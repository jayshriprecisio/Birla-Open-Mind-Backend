...
const StudentAdmissions = sequelize.define(
  "StudentAdmissions",
  {
    ...
    father_employer_address_line1: { type: DataTypes.STRING(1000) },
    father_employer_address_line2: { type: DataTypes.STRING(1000) },
    father_employer_address_line3: { type: DataTypes.STRING(1000) },
    ...
    mother_employer_address_line1: { type: DataTypes.STRING(1000) },
    mother_employer_address_line2: { type: DataTypes.STRING(1000) },
    mother_employer_address_line3: { type: DataTypes.STRING(1000) },
