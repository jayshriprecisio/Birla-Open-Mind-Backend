...
const SchoolEnquiryFollowup = sequelize.define('SchoolEnquiryFollowup', {
  ...
  followup_by: { type: DataTypes.BIGINT },
  priority: { type: DataTypes.STRING(20) },
  priority_id: { type: DataTypes.BIGINT },
  stage_id: { type: DataTypes.BIGINT },
  followup_status_id: { type: DataTypes.BIGINT },
  counsellor_id: { type: DataTypes.BIGINT },
