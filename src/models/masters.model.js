...
const AcademicSubjectMaster = sequelize.define('AcademicSubjectMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const BoardMaster = sequelize.define('BoardMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const ChequeFavourMaster = sequelize.define('ChequeFavourMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const FeesCategoryMaster = sequelize.define('FeesCategoryMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const FeesSubTypeMaster = sequelize.define('FeesSubTypeMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const FeesTypeMaster = sequelize.define('FeesTypeMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const HouseMaster = sequelize.define('HouseMaster', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
const ModeOfPaymentMaster = sequelize.define('ModeOfPaymentMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const PdcStatusMaster = sequelize.define('PdcStatusMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const PeriodOfServiceMaster = sequelize.define('PeriodOfServiceMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const PrePrimaryPhaseMaster = sequelize.define('PrePrimaryPhaseMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const PrePrimarySubjectMaster = sequelize.define('PrePrimarySubjectMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
  name: { type: DataTypes.STRING(150), allowNull: false },
  short_form: { type: DataTypes.STRING(20) },
  status: { type: DataTypes.STRING(10), defaultValue: 'ACTIVE' },
...
const SchoolTimingMaster = sequelize.define('SchoolTimingMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const ServiceProviderMaster = sequelize.define('ServiceProviderMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const SessionMaster = sequelize.define('SessionMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const StreamMaster = sequelize.define('StreamMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
  name: { type: DataTypes.STRING(100), allowNull: false },
  short_form: { type: DataTypes.STRING(20) },
  status: { type: DataTypes.STRING(10), defaultValue: 'ACTIVE' },
...
const StudentAttendanceStatusMaster = sequelize.define('StudentAttendanceStatusMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
  name: { type: DataTypes.STRING(100), allowNull: false },
  short_form: { type: DataTypes.STRING(20) },
  status: { type: DataTypes.STRING(10), defaultValue: 'ACTIVE' },
...
const SubjectGroupMaster = sequelize.define('SubjectGroupMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const SubjectTypeMaster = sequelize.define('SubjectTypeMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
  name: { type: DataTypes.STRING(150), allowNull: false },
  short_form: { type: DataTypes.STRING(20) },
  status: { type: DataTypes.STRING(10), defaultValue: 'ACTIVE' },
...
const TransactionTypeMaster = sequelize.define('TransactionTypeMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const WinterDurationMaster = sequelize.define('WinterDurationMaster', {
  id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
const WinterTimingGapMaster = sequelize.define('WinterTimingGapMaster', {
  id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
module.exports = {
  AcademicMaster, AcademicSubjectMaster, AcademicYearMaster, BatchMaster, BoardMaster,
  BrandMaster, CalculationBasisMaster, ChequeFavourMaster, CourseMaster, DivisionMaster,
  FeesCategoryMaster, FeesSubTypeMaster, FeesTypeMaster, GenderMaster, GradeMaster,
  HouseMaster, ModeOfPaymentMaster, ParameterMaster, PaymentEntityMaster, PdcStatusMaster,
  PeriodOfServiceMaster, PrePrimaryPhaseMaster, PrePrimarySubjectMaster, SchoolTimingMaster,
  ServiceProviderMaster, SessionMaster, StreamMaster, StudentAttendanceStatusMaster,
  SubjectGroupMaster, SubjectTypeMaster, TermMaster, TransactionTypeMaster,
  WinterDurationMaster, WinterTimingGapMaster, ZoneMaster
};
